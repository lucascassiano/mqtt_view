...
class NsisTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    buildInstaller(filesToDelete) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            const installerFilename = packager.expandArtifactNamePattern(options, "exe", null, "${productName} " + (_this4.isWebInstaller ? "Web " : "") + "Setup ${version}.${ext}");
            ...
            if (_this4.isWebInstaller) {
                ...
                if (appPackageUrl == null) {
                    const publishConfigs = yield (0, (_PublishManager || _load_PublishManager()).getPublishConfigsForUpdateInfo)(packager, (yield (0, (_PublishManager || _load_PublishManager()).getPublishConfigs)(packager, _this4.options, false)));
                    if (publishConfigs == null || publishConfigs.length === 0) {
                        throw new Error("Cannot compute app package download URL");
                    }
                    appPackageUrl = (0, (_PublishManager || _load_PublishManager()).computeDownloadUrl)(publishConfigs[0], null, packager.appInfo.version, {
                        os: (_electronBuilderCore || _load_electronBuilderCore()).Platform.WINDOWS.buildConfigurationKey,
                        arch: ""
                    });
            ...
            yield (0, (_log || _load_log()).subTask)(`Executing makensis — installer`, _this4.executeMakensis(defines, commands, true, (yield _this4.computeScript(defines, commands, installerPath))));
            yield packager.sign(installerPath);
            packager.dispatchArtifactCreated(installerPath, _this4, `${packager.appInfo.name}-${_this4.isWebInstaller ? "Web-" : ""}Setup-${version}.exe`);
        })();
    }
    get isWebInstaller() {
        return this.name === "nsis-web";
    }
    computeScript(defines, commands, installerPath) {
        var _this5 = this;
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            yield (0, (_log || _load_log()).subTask)(`Executing makensis — uninstaller`, _this5.executeMakensis(defines, commands, false, script));
    ...
    configureDefines(oneClick, defines) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (!_this6.isWebInstaller && defines.APP_BUILD_DIR == null) {
                if (options.useZip) {
    ...
    executeMakensis(defines, commands, isInstaller, originalScript) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            if (fileAssociations.length !== 0) {
                if (_this7.options.perMachine !== true) {
